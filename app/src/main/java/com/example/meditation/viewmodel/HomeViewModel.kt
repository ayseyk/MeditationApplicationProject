...
class HomeViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private fun getStories(){
        ...
        val s2 = Story(R.drawable.s2, "Cozy Campfire","Donec pede justo")
        val s3 = Story(R.drawable.s3, "Night Call","Curabitur ullamcorper")
        val s4 = Story(R.drawable.s4, "The Flower Garden ","Maecenas tempus")
        val s5 = Story(R.drawable.s5, "The Time Machine","Etiam sit amet orci")
        val s6 = Story(R.drawable.s6, "1001 Nights","Sed fringilla mauris sit")
